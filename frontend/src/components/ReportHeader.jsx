...
import { Car, Fuel, Calendar, Palette, FileDown } from 'lucide-react'
    ...
    <div className="card flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
      <div>
        ...
        <button
          ...
          className="no-print mt-4 inline-flex items-center gap-2 px-5 py-2.5 bg-blue-700 hover:bg-blue-800 active:bg-blue-900 text-white font-semibold text-sm rounded-lg shadow transition-colors"
        >
          <FileDown size={16} />
          Save report as PDF
        </button>
